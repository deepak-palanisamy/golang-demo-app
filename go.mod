module github.com/deepak-palanisamy/golang-demo-app

go 1.19

require github.com/aws/aws-cdk-go/awscdk/v2 v2.59.0

require (
	github.com/Masterminds/semver/v3 v3.2.0 // indirect
	github.com/aws/constructs-go/constructs/v10 v10.1.214 // indirect
